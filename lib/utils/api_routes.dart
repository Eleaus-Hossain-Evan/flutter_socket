...
class APIRoute {
  ...
  static const String MESSAGE_LIST = "${API_V1}message/list";
  static const String MESSAGE_VIEW = "${API_V1}message/view";
  static const String MESSAGE_SEND = "${API_V1}message/send";
  ...
  static const String DEVICE_TOKEN = "${API_V1}student/set-device-token";
  static const String GOOGLE_LIGNIN =
      "${API_V1}utility/google-login?user=student";
  static const String FACEBOOK_LIGNIN =
      "${API_V1}utility/facebook-login?user=student";
  ...
  static const String FORGOT_PASSWORD_STEP_1 =
      "${API_V1}utility//forget-password/get-otp?user=student";
  static const String FORGOT_PASSWORD_STEP_2 =
      "${API_V1}utility/forget-password/validate-otp?user=student";
  static const String FORGOT_PASSWORD_STEP_3 =
      "${API_V1}utility/forget-password/reset-password?user=student";

  //#<<=================== LMS =======================>>
  static const String HOME = "${API_V1}home?user=app";
  static const String SETTINGS = "${API_V1}settings/fetch?type=app";
  ...
  static const String COURSE_BY_CATEGORY =
      "${API_V1}course/get-subCat-courses?subId=";
  ...
  static const String NOTIFICATION = "${API_V1}student/get-notifications";
  static const String MARK_NOTIFICATION =
      "${API_V1}utility/update-notifications?";
